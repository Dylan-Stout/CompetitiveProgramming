...
public class OpenTheLock {
	/**
	 * 
	 * @param deadends - range [1,500] 
	 * @param target - not in list of deadends 
	 * @return number of turns that are required to meet target without hitting deadend
	 * 		   return -1 if impossible to open lock with given parameters
	 */
    ...
    public String turnLock(String lock, int index, int incrementor)
    {
